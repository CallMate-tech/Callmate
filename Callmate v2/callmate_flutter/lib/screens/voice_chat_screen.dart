...
class VoiceChatScreen extends StatefulWidget {
  final String userId;
  const VoiceChatScreen({super.key, required this.userId});
              ...
              child: Stack(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    height: isPlaying ? 200 * _animationController.value : 170,
                  ...
                  Icon(Icons.podcasts_rounded, size: 100, color: Colors.white),
                ],
              ),
            ),
          ),
